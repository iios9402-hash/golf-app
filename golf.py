...
# バージョン情報を付与してキャッシュを強制的に更新させます (v2.0.1)
st.set_page_config(page_title="矢板CC 監視システム v2.0.1", layout="wide")
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                for i in range(len(daily['time'])):
                    ...
                    # 判定アルゴリズム (1-10, 14日目 vs 11-13日目警戒)
...
if not df.empty:
    ...
    if st.button("🔄 システムを強制的にリロードして再取得"):
        st.cache_data.clear()
        st.rerun()
